...
var modalNav = function () {
  var functions = {
    open_modal: function (selector) {
      ...
      gsap.fromTo(selector, { scale: 0 }, { duration: 0.5, scale: 1, display: "block", opacity: 1 });
    ...
    openSection: function (sectionId, effect) {
      ...
      switch (effect) {
        case 'slide':
          gsap.fromTo(`#${sectionId}`, { opacity: 0, x: 100 }, { duration: 0.5, opacity: 1, x: 0, display: 'block' });
          break;
        case 'fade':
          gsap.fromTo(`#${sectionId}`, { opacity: 0 }, { duration: 0.5, opacity: 1, display: 'block' });
          break;
        case 'zoom':
          gsap.fromTo(`#${sectionId}`, { opacity: 0, scale: 0.5 }, { duration: 0.5, opacity: 1, scale: 1, display: 'block' });
          break;
        case 'rotate':
          gsap.fromTo(`#${sectionId}`, { opacity: 0, rotation: -180 }, { duration: 0.5, opacity: 1, rotation: 0, display: 'block' });
          break;
        case 'flip':
          gsap.fromTo(`#${sectionId}`, { opacity: 0, rotationY: 180 }, { duration: 0.5, opacity: 1, rotationY: 0, display: 'block' });
          break;
        case 'skew':
          gsap.fromTo(`#${sectionId}`, { opacity: 0, skewX: 30 }, { duration: 0.5, opacity: 1, skewX: 0, display: 'block' });
          break;
        case 'scale-rotate':
          gsap.fromTo(`#${sectionId}`, { opacity: 0, scale: 0.5, rotation: -180 }, { duration: 0.5, opacity: 1, scale: 1, rotation: 0, display: 'block' });
          break;
        default:
      ...
      $(document).ready(function () {
        ...
        setTimeout(() => {
          $(".typing").text(function () {
            return $(this).closest(".top-menu-legend").hasClass("close") ? "Fechar" : "Menu";
          });
        }, 10);
      });
    },
